...
<script>
    function helloWorld()
    {
        ...
        document.getElementById("show").value = NameService.HelloWorld("Tobe") + ". "; //undefined value returned
    }
    ...
    function add()
    {
        ...
        //document.getElementById("showSum").value = $get(ArithmeticService.Sum(a, b, addCallBack)+". "); 
        //tryimg to assign json value returned from service to jjavascript variable, impossible
    }
