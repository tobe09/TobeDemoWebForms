...
<asp:Content ID="CgpaContent" runat="server" ContentPlaceHolderID="Content">
    ...
    <div style="margin-left:150px;margin-right:100px;">
        ...
        <asp:Table ID="ValueTable" runat="server" Width="600px" CssClass="centre" GridLines="Both">
            <asp:TableHeaderRow>
        ...
        <div id="CgpaDiv" runat="server" visible="false" style="margin-left:100px">
            <br />
            <br /><br />
        <asp:Label ID="CgpLabel" runat="server"></asp:Label><br />
        <asp:Label ID="CuLabel" runat="server"></asp:Label><br />
        <asp:Label ID="CgpaLabel" ForeColor="Green" Font-Size="22px" runat="server"></asp:Label><br /><br />
    </div>    
    </div>
