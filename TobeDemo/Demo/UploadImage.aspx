<%@ Page Language="C#" MasterPageFile="~/MasterPages/TobeDemoMaster.Master" Title="Uploaad an Image" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="UploadImage.aspx.cs" Inherits="TobeDemo.Demo.UploadImage" %>
...
<asp:Content ContentPlaceHolderID="Content" ID="ImageContent" runat="server">
    ...
    <div style="margin-left: 300px;">
        ...
        Enter your username:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="UsernameBox2" runat="server"></asp:TextBox>
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Image ID="Image1" Visible="false" runat="server" Width="200px" Height="200px" /><br />
        <br />
    ...
    <div style="margin-left: 300px;">
        ...
        Username:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="UsernameBox3" runat="server"></asp:TextBox>
        <br />
        <br />
    ...
    <div style="margin-left: 300px;">
        ...
        Enter your username:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="UsernameBox4" runat="server"></asp:TextBox>
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Image ID="Image4" Visible="false" runat="server" Width="200px" Height="200px" /><br />
        <br />
        <asp:Label ID="InfoLabel4" runat="server" Text=""></asp:Label>
    </div>

    <div id="doPostBackForm">
        <span>
            <p>Click to see alert with your name</p>
        </span>
        <span>Enter your name: </span>
        <asp:TextBox ID="nameLblTest" runat="server"></asp:TextBox><br />
        <button id="testDoPostBackBtn" runat="server" onserverclick="TestDoPostBack">Show Alert</button>
    </div>
    <script>
        function __doPostBack(target, handler) {
            let theForm = document.forms['MasterForm'];
            theForm.__EVENTTARGET.value = target;
            theForm.__EVENTARGUMENT.value = handler;
            theForm.submit();
        }
    </script>
    <br />
